...
python3 control_center/build_manifest.py 1.3.0
...
semantic version, such as `v1.3.0`, then publish a non-draft, non-prerelease GitHub
...
For the next release, increase the version (for example, `1.3.1` for a bug fix or `1.4.0`
